...
|-----------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [`AssetId`](#lacing.model.AssetId)              | A content-addressed artifact identity — the SHA-256 of the artifact's bytes, as [`lacing.Artifact`](lacing.md#lacing.Artifact) enforces: **bare 64-hex only**. |
...
bytes, as [`lacing.Artifact`](lacing.md#lacing.Artifact) enforces: **bare 64-hex only**.
...
### lacing.model.UNKNOWN_GENERATED_AT *: [RationalTime](lacing.time.md#lacing.time.RationalTime)* *= RationalTime(0, 24000)*
