...
([`lacing.store.migrations`](lacing.store.migrations.md#module-lacing.store.migrations)).
...
* **Parameters:**
  * **tier** ([`Tier`](lacing.tier.md#lacing.tier.Tier)) – Tier definition.
...
Bases: [`LossyTimeConversionError`](lacing.time.md#lacing.time.LossyTimeConversionError)
...
| [`base`](lacing.store.base.md#module-lacing.store.base)             | `IntervalAnnotationStore` — the headline Pythonic API.                      |
|--------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|
| [`memory`](lacing.store.memory.md#module-lacing.store.memory)         | In-memory annotation store backed by an interval tree.                      |
| [`migrations`](lacing.store.migrations.md#module-lacing.store.migrations) | Store-level schema migrations — the on-disk counterpart of the body ladder. |
| [`postgres`](lacing.store.postgres.md#module-lacing.store.postgres)     | PostgreSQL-backed annotation store using `int8range` + GiST.                |
| [`sqlite`](lacing.store.sqlite.md#module-lacing.store.sqlite)         | SQLite-backed annotation store and the `.annot` portable file format.       |
