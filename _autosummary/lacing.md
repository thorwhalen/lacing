...
* **Return type:**
  [`AllenRelation`](lacing.allen.md#lacing.allen.AllenRelation)
...
#### *property* interval *: [TimeInterval](lacing.time.md#lacing.time.TimeInterval) | [None](https://docs.python.org/3/builtins/constants.html#None)*
...
* **Return type:**
  [`Artifact`](lacing.artifact.md#lacing.artifact.Artifact)
...
* **Return type:**
  [`ArtifactStore`](lacing.artifact_store.md#lacing.artifact_store.ArtifactStore)
...
* **Return type:**
  [`Iterator`](https://docs.python.org/3/library/collections.abc.html#collections.abc.Iterator)[[`OpLogEntry`](lacing.oplog.md#lacing.oplog.OpLogEntry)]
...
* **Return type:**
  [`RationalTime`](lacing.time.md#lacing.time.RationalTime)
...
#### *property* duration *: [RationalTime](lacing.time.md#lacing.time.RationalTime)*
...
* **Return type:**
  [`TimeInterval`](lacing.time.md#lacing.time.TimeInterval)
...
* **Parameters:**
  * **log** ([`OpLog`](lacing.oplog.md#lacing.oplog.OpLog)) – Source op-log.
...
| [`adapters`](lacing.adapters.md#module-lacing.adapters)             | I/O adapter registry.                                                     |
|----------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|
| [`allen`](lacing.allen.md#module-lacing.allen)                   | Allen's 13 interval relations as pure predicates.                         |
| [`artifact`](lacing.artifact.md#module-lacing.artifact)             | Content-addressed artifact references.                                    |
| [`artifact_store`](lacing.artifact_store.md#module-lacing.artifact_store) | Artifact store — a metadata catalog and a blob store behind one facade.   |
| [`bodies`](lacing.bodies.md#module-lacing.bodies)                 | Built-in body schemas.                                                    |
| [`cli`](lacing.cli.md#module-lacing.cli)                       | Command-line interface for lacing.                                        |
| [`digest`](lacing.digest.md#module-lacing.digest)                 | Content digests over an annotation's *value* — the freshness primitive.   |
| [`exhibit`](lacing.exhibit.md#module-lacing.exhibit)               | Artifact exhibit — render an annotation graph as a readable document.     |
| [`model`](lacing.model.md#module-lacing.model)                   | Annotation envelope, references, and provenance.                          |
| [`oplog`](lacing.oplog.md#module-lacing.oplog)                   | Operation log for time-travel debug + audit.                              |
| [`otel`](lacing.otel.md#module-lacing.otel)                     | Optional OpenTelemetry instrumentation for the lacing server.             |
| [`processors`](lacing.processors.md#module-lacing.processors)         | Background processors — pluggable jobs that run against a store + op-log. |
| [`quality`](lacing.quality.md#module-lacing.quality)               | Inter-annotator agreement and boundary metrics.                           |
| [`schema`](lacing.schema.md#module-lacing.schema)                 | Body schema registry, JSON Schema export, and migrations.                 |
| [`store`](lacing.store.md#module-lacing.store)                   | Interval-keyed annotation stores.                                         |
| [`tier`](lacing.tier.md#module-lacing.tier)                     | Tiers and the five ELAN stereotypes.                                      |
| [`time`](lacing.time.md#module-lacing.time)                     | Rational time and half-open intervals — the foundations.                  |
| [`tracks`](lacing.tracks.md#module-lacing.tracks)                 | High-level "track-shaped" facades on top of `lacing`.                     |
| [`worker`](lacing.worker.md#module-lacing.worker)                 | Optional Arq integration — queue processors through Redis.                |
