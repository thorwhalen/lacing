...
| [`annot`](lacing.adapters.annot.md#module-lacing.adapters.annot)                   | `.annot` portable file format adapter.                            |
|-------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|
| [`eaf`](lacing.adapters.eaf.md#module-lacing.adapters.eaf)                       | ELAN EAF adapter (Max Planck Institute's annotation tool format). |
| [`jams`](lacing.adapters.jams.md#module-lacing.adapters.jams)                     | JAMS (JSON Annotated Music Specification) adapter.                |
| [`label_studio`](lacing.adapters.label_studio.md#module-lacing.adapters.label_studio)     | Label Studio JSON adapter.                                        |
| [`otio`](lacing.adapters.otio.md#module-lacing.adapters.otio)                     | OpenTimelineIO (OTIO) adapter — NLE / video editing interchange.  |
| [`textgrid`](lacing.adapters.textgrid.md#module-lacing.adapters.textgrid)             | Praat TextGrid adapter.                                           |
| [`web_annotation`](lacing.adapters.web_annotation.md#module-lacing.adapters.web_annotation) | W3C Web Annotation Data Model adapter (JSON-LD).                  |
| [`webvtt`](lacing.adapters.webvtt.md#module-lacing.adapters.webvtt)                 | WebVTT (W3C TimedText) adapter.                                   |
